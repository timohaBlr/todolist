...
import {
    addNewTaskAC,
    changeStatusAC,
    changeTaskTitleAC, newTasksNewTodolistAC,
    removeTaskAC,
...
function App() {
   ...
   let todolistTasks = tasksS[todolistId];
   // перезапишем в этом объекте массив для нужного тудулиста отфилтрованным массивом:
   tasksS[todolistId] = todolistTasks.filter(t => t.id != id);
   // засетаем в стейт копию объекта, чтобы React отреагировал перерисовкой
   setTasksS({...tasksS});*/
    }

    function addTask(title: string, todolistId: string) {
        dispatchTasks(addNewTaskAC(title,todolistId))
        /* let task = {id: v1(), title: title, isDone: false};
         //достанем нужный массив по todolistId:
         let todolistTasks = tasksS[todolistId];
         // перезапишем в этом объекте массив для нужного тудулиста копией, добавив в начало новую таску:
         tasksS[todolistId] = [task, ...todolistTasks];
         // засетаем в стейт копию объекта, чтобы React отреагировал перерисовкой
         setTasksS({...tasksS});*/
    }
...
setTasks({...tasks});*/
    ...
    function addTodolist(title: string) {
        ...
        dispatchTasks(newTasksNewTodolistAC(newTodolistId))
